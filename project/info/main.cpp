...
void introScreen()
{
	glClear(GL_COLOR_BUFFER_BIT);
		...
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-425, 490, 0.0,"This stack simulation.");
  glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-300, 390, 0.0,"Here we can easily simulate the stack concept.\n");
	glColor3f(1.0, 0.0, 0.0);
	displayRasterText(-200, 290, 0.0,"Press Enter to start");
	glFlush();
 	glutSwapBuffers();
}
...
{
system("F:\\cg\\project\\Q\\bin\\Debug\\Q.exe");
exit(0);
}
